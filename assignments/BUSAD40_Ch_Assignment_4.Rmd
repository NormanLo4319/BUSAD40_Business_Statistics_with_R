...
b. Calcualte and fill out the rest of the statistics in the table.
...
c. Calculate the estimated slope of the regression model. (Show Work!)

$\beta_1$ = 


d. Calculate the estimated y-intercept of the regression model. (Show Work!)

$\beta_0$ = 


e. Write out the estimated regression equation fitting the data. 
...
g. Calculate the Residual Sum of Squares, Total Sum of Squares, and Explained Sum of Squares with the results from part f.
