...
In this exercise, we will examine the **Carseats** data, which is part of the ISLR library. We will attempt to model **Sales** (child car seat sales) in 400 locations based on a independent variables.
