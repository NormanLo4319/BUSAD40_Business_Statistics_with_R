...
In this exercise, we will examine the **Carseats** data, which is part of the ISLR library. We will attempt to model **Sales** (child car seat sales) in 400 locations based on an independent variables.
...
a. Use the model in **Question 1 part d**, predict the **Sales** given the price of the carseat \$50, \$100, and \$150.
...
b. Create a 95% confidence intervale for your prediction in **part a**.
...
d. Is there anyway we can increase the explanatory power of the linear model? If yes, what would you suggest to do to improve the model fit? You can provide your code to proof your suggestion, but it is optional!!
