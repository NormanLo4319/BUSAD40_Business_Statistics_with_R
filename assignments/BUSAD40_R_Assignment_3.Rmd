...
In a tech company, a project manager is planning on running an online promotion, whcih offers a 50% discount pomotion code on their service for the first three months. The manager projects to at least \$500 revenue per account. The previous pomotion events shows the average revenue per account is \$488 with standard deviation \$52 and it's normally distributed. Suppose the manager plans to starts with 100 existing accounts to send them the code and evaluate the effectiveness of the promotion.

a. Create the 95% confidence intervals to demonstrates the potential return from this trial.
