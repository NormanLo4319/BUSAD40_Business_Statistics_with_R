...
g. Use the fitted model to predict dan.grump using the following values.

dan.sleep = 7.2, 8.3, 9.1

```{r}
# Use the predict function to make prediction with 95% confidence interval
