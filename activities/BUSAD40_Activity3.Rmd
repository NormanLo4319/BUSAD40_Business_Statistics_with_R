...
2. What is the probability either Event A or Event B happen? $P(A \cup B)$

Ans:

3. What is the probability Event C happen given Event A? $P(C|A)$
...
e. What is the probability to successfully sell exactly 50 products by running the automation system for **10 minutes**? P(X = 85)

f. What is the probability to successfully sell 100 products or more by running the automation system for **20 minutes**? P(X $\geq$ 220)
...
print("This distriubtion is called ______________ and the shape of the data distribution of the product sales is ________________")
...
print(paste("There is a 80% chance to sell ",  , " or less products by running the automation system for 20 minutes."))
